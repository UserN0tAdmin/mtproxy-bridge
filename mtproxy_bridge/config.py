...
# Предельный срок открытия WEB-стрима одним клиентом (включая ожидание
# общей сессии). Без него клиенты, застрявшие в очереди к недоступному
# релею, копятся бесконечно (Kurigram плодит сокеты быстрее, чем они
# умирают в retry-циклах bootstrap'а).
WEB_STREAM_OPEN_TIMEOUT_SECS = 20.0
